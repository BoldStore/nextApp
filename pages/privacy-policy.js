...
function PrivacyPolicy() {
  return (
    <div>
      ...
      >
        <h1>Privacy Policy Last updated [April 06th, 2022]. </h1>
        <br />
        <p>
        ...
        <p>
          ...
          Mobile Application Bold. Here at Bold, we are committed to protecting
        ...
        <p>
          When you visit our Mobile Application Bold (“Mobile Application”) and
          ...
          concerning it. We hope you take some time to read through it
        ...
        <p>
          ...
          information that you voluntarily provide to us when registering with
          us, expressing an interest in obtaining information about us or our
          products and services, when participating in activities on the Mobile
          Application, or otherwise contacting us. The personal information that
          we collect depends on the context of your interactions with us and the
          Mobile Application, the choices you make, and the services and
          features you use. The personal information we collect can include the
          following: Name and Contact Data. We collect your Name,Age, Phone
          Number, Email, Address, Size preference , Instagram username Instagram
          Display Data. We provide you with the option to connect your instagram
          account if you are signing up as a store and thus collect all of your
          posts data - their img urls , caption, etc. Payment Data. We collect
          data necessary to process your payment if you make purchases, such as
          your payment instrument number (such as a credit card number), and the
          ...
          privacy policies and contact the payment processor directly to respond
          to your questions. Information automatically collected We
          automatically collect certain information when you visit, use or
          navigate the Mobile Application. This information does not reveal your
          specific identity (like your name or contact information) but may
          include device and usage information, such as your IP address,
          browser, and device characteristics, operating system, language
          preferences, referring URLs, device name, country, location,
          information about how and when you use our Mobile Application and
          other technical information. If you access our Mobile Application with
          ...
          primarily needed to maintain the security and operation of our Mobile
          Application, and for our internal analytics and reporting purposes.
          Like many businesses, we also collect information through cookies and
          similar technologies. You can find out more about this in our Cookie
          Policy. Information collected from other Sources We may obtain
          information about you from other sources, such as public databases,
          joint marketing partners, social media platforms (such as Instagram),
          as well as from other third parties.
        </p>
        ...
        <p>
          ...
          receive: <br />• To build your E-store profile in our app so that your
          customers can buy your products using our app and we handle the
          payment and the delivery of these products.
          <br /> • To deliver products to the addresses provided so that your
          customers can receive the said products..
          <br /> • To send administrative information to you related to your
          account, our business purposes, and/or for legal reasons. We may use
          your personal information to send you a product, service, and new
          feature information, and/or information about changes to our terms,
          conditions, and policies.
          <br /> • Deliver targeted advertising to you for our Business Purposes
          ...
          <br /> • To protect our Mobile Application for Business Purposes
          and/or Legal Reasons. We may use your information as part of our
          efforts to keep our Mobile Application safe and secure (for example,
          for fraud monitoring and prevention).
          <br /> • To enforce our terms, conditions, and policies for our
          business purposes and as legally required.
          <br /> • To respond to legal requests and prevent harm as legally
          ...
          and evaluating and improve our Mobile Application, services,
        ...
        <p>
          ...
          situations:
          <br /> • Compliance with Laws. We may disclose your information where
          we are legally required to do so to comply with applicable law,
          ...
          <br /> • Vital Interests and Legal Rights. We may disclose your
          ...
          <br /> • With your Consent. We may disclose your personal information
          ...
          Mobile Application) or otherwise interact with public areas of the
          Mobile Application, such personal information may be viewed by all
          users and may be publicly distributed outside the Mobile Application
          in perpetuity.
        </p>
        ...
        <p>
          Information collected from you may be stored and processed globally in
          various countries in which our Company or agents or contractors
          maintain facilities, and by accessing our sites and using our
          services, you consent to any such transfer of information outside of
          your country. Such countries may have laws that are different, and
          potentially not as protective, as the laws of your own country.
          Whenever we share personal data originating in the European Economic
          Area we will rely on lawful measures to transfer that data, such as
          the Privacy Shield or the EU standard contractual clauses. If you
          reside in the EEA or other regions with laws governing data collection
          and use, please note that you are agreeing to the transfer of your
          personal data to the United States and other countries in which we
          operate. By providing your personal data, you consent to any transfer
          and processing in accordance with this Policy. We will not transfer
          your personal information to an overseas recipient.
        </p>
        <h3>6. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES? </h3>
        <p>
          The Mobile Application may contain advertisements from third parties
          ...
          safety and privacy of the data you provide to any third parties. Any
          data collected by third parties is not covered by this privacy policy.
          ...
          services, or applications that may be linked to or from the Mobile
          Application. You should review the policies of such third parties and
        ...
        <p>
          ...
          information to and from our Mobile Application is at your own risk.
          You should only access the services within a secure environment.
          <h3>9. WHAT ARE YOUR PRIVACY RIGHTS? </h3>
          <p>
            Account Information You may at any time review or change the
            information in your account or terminate your account by: <br />•
            ...
            services of our Mobile Application.
          </p>
        </p>
